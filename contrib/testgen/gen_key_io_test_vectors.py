...
bech32_templates = [
  ...
  ('cpr',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('cpr',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('cpr',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('cpr',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tcpr',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tcpr',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tcpr',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tcpr',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tcpr',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tcpr',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tcpr',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tcpr',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rcpr',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rcpr',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rcpr',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rcpr', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tcpr',   17, 32, Encoding.BECH32M, False, False, False),
  ('rcpr',  3,  1, Encoding.BECH32M, False, False, False),
  ('cpr',   15, 41, Encoding.BECH32M, False, False, False),
  ('tcpr',    0, 16, Encoding.BECH32,  False, False, False),
  ('rcpr',  0, 32, Encoding.BECH32,  True,  False, False),
  ('cpr',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tcpr',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rcpr',  0, 20, Encoding.BECH32,  False, False, True),
  ('cpr',    0, 20, Encoding.BECH32M, False, False, False),
  ('tcpr',    0, 32, Encoding.BECH32M, False, False, False),
  ('rcpr',  0, 20, Encoding.BECH32M, False, False, False),
  ('cpr',    1, 32, Encoding.BECH32,  False, False, False),
  ('tcpr',    2, 16, Encoding.BECH32,  False, False, False),
  ('rcpr', 16, 20, Encoding.BECH32,  False, False, False),
]
