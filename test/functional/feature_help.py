...
"""Verify that starting coppercoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start coppercoin with -h for help text")
        ...
        self.log.info("Start coppercoin with -version for version information")
        ...
        self.log.info("Start coppercoind with -fakearg to make sure it does not start")
