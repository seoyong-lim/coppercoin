...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " coppercoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  coppercoin-tx [options] <hex-tx> [commands]  Update hex-encoded coppercoin transaction\n" +
            "or:     coppercoin-tx [options] -create [commands]   Create hex-encoded coppercoin transaction\n" +
            "\n";
