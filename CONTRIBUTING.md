Contributing to Coppercoin Core
============================

The Coppercoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Coppercoin Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/coppercoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to coppercoin-qt
...
The following applies to code changes to the Coppercoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Coppercoin
Network Protocol consensus changes.

Whether a pull request is merged into Coppercoin Core rests with the project merge
...
Patches that change Coppercoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Coppercoin consensus, it must have been
...
The project leader is the release manager for each Coppercoin Core release.
