# Support for Output Descriptors in Coppercoin Core

Since Coppercoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `cpr1...` for mainnet or `tcpr1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing Coppercoin Core wallets, a convenience function `combo` is
