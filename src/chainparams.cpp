...
{
    const char* pszTimestamp = "THE AUSTRALIAN 06/Jun/2023 More mortgage pain as RBA hikes again";
    const CScript genesisOutputScript = CScript() << ParseHex("041e594b8a850ffb9e9bebafd8f3082d264a2e1ecb189d56c53484a0a388e5edb10eb9e719ad1b29812da1db6787182ffbb8723f453e45286026fd30ba55e5d38f") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1685839679, 2077939427, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x652edc261becfbb75f038f6a594025988759070ac8304e07b4930b176d5f181d"));
        assert(genesis.hashMerkleRoot == uint256S("0xfdf33c5c66d996dcf10ddb7e68aeac88418ae9bf08611cfab9a8ad0071df9081"));
        ...
        /*
        vSeeds.emplace_back("seed-a.coppercoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.coppercointools.com");
        vSeeds.emplace_back("dnsseed.coppercoinpool.org");
        ...
        */
        ...
        checkpointData = {
            {
                {0, uint256S("0x652edc261becfbb75f038f6a594025988759070ac8304e07b4930b176d5f181d")},
                /*
        ...
        chainTxData = ChainTxData{
            ...
            /* nTime    1641142661*/  1685839679,
            /* nTxCount 100225898 */ 0,
            /* dTxRate  */ 0.0
        };
    }
};
...
public:
    CTestNetParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xf02e997b43f570b93d355497e183a7333d4309edbe524d9e462248d2ff66ee32"));
        assert(genesis.hashMerkleRoot == uint256S("0xfdf33c5c66d996dcf10ddb7e68aeac88418ae9bf08611cfab9a8ad0071df9081"));
        ...
        /*
        vSeeds.emplace_back("testnet-seed.coppercointools.com");
        vSeeds.emplace_back("seed-b.coppercoin.loshan.co.uk");
        ...
        */
        ...
        chainTxData = ChainTxData{
            ...
            /* nTime   1607986972 */ 1686133546, 
            /* nTxCount 4229067 */ 0,
            /* dTxRate  0.06527021772939347*/ 0.0,
        };
    }
};
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();        
        assert(consensus.hashGenesisBlock == uint256S("0x27f3c3cc59297943733eede9d55606c6b87108a4ae9f48f9d0e2aee49e904fd3"));
        assert(genesis.hashMerkleRoot == uint256S("0xfdf33c5c66d996dcf10ddb7e68aeac88418ae9bf08611cfab9a8ad0071df9081"));
